...
public class BrowserUtils {
    ...
    //------- may not function properly--------getLocatorFromWebElement() ----can be changed by---------
    public static void waitForPresenceOfLocatedElement(WebElement element, int timeOutInSecond) {
        //needs to be controlled. DataTableListMap.feature you can use the codes here
    ...
    //***** isDisplayed() method is customized ***************************************
/*
 ...
 */
    ...
    public static void verifyVideoPlays(WebElement element) {
        //pre cond: user clicks on YouTube video
    ...
    // My method - getChildTitle() - get Child Window Title - my method -
    ...
    public static String getChildWindowURL() {
        ...
        //Driver.getDriver().switchTo().window(parent); -> error
        return childUrl;
    }
    ...
    // clear Text box by javascript
    public static void clearTextboxByJs(WebElement element) {
        JavascriptExecutor js = (JavascriptExecutor) Driver.getDriver();
        js.executeScript("arguments[0].value = '';", element);
    }

    //------------check the following JS codes------------------------
