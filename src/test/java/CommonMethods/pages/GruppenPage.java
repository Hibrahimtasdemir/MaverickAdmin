...
public class GruppenPage extends Base {
    ...
    /*
    This element is for clicking Gruppen
     */
    ...
    */
    ...
    public void StichwortFilternField(String stichwort) {
        ...
        BrowserUtils.clickWithJS(stichwortFilternArea);
    ...
    @FindBy(xpath = "//div[@role='rowheader']")
    private List<WebElement> selectGroupNames;

    public void selectAndClickGroupName(String groupNamePrefix){
        for (WebElement group : selectGroupNames){
            if (group.getText().startsWith(groupNamePrefix)){
                group.click();
                BrowserUtils.waitFor(3);
                break;
            }
